...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize"> Animals</p>
                <h4 class="mb-0">{{$totalAnimals}}</h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
      ...
      <div class="row mt-4">
        ...
        <div class="col-lg-4 col-md-6 mt-4 mb-4">
          <div class="card z-index-2  ">
            ...
            <div class="card-body">
              <h6 class="mb-0 "> Daily Product Sales </h6>
              <div class="d-flex ">
                <i class="material-icons text-sm my-auto me-1">schedule</i>
                <p class="mb-0 text-sm">just updated</p>
              </div>
        ...
        <div class="col-lg-4 mt-4 mb-3">
          <div class="card z-index-2 ">
            ...
            <div class="card-body">
              <h6 class="mb-0 ">Daily Milk Production</h6>
  ...
  <script>
    ...
    var labelsexpense = {!! json_encode($labelsexpense) !!};
    var dataexpense = {!! json_encode($dataexpense) !!};
var expensedetails = {!! json_encode($expensedetails) !!};
    new Chart(ctx, {
      type: "bar",
      data: {
...
// Replace the static data with the dynamic data passed from the controller
...
new Chart(ctx2, {
  ...
  options: {
    ...
    var labelsmilk = {!! json_encode($labelsmilk) !!};
var datamilk = {!! json_encode($datamilk) !!};
    new Chart(ctx3, {
      type: "line",
      data: {
        labels: labelsmilk,
